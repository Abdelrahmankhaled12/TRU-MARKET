      ...
      <ContentWrapper>
        ...
        <div className="grid">
          ...
          <div className="text" data-aos="fade-up"
            ...
            <h1>Earn 15% APY by investing in sustainable global trade.</h1>
            {/* Description for the banner */}
            <p>We enable smart contracts to finance producers conduct sustainable agro-export operations while cutting intermediaries.</p>
